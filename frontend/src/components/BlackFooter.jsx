...
import footer_logo from "../assets/logoFinal.png";

export default function BlackFooter() {
  return (
    <footer className="w-full bg-black  ">
      <div className="max-w-[1700px] mx-auto px-6 sm:px-10 lg:px-[78px] py-6 lg:py-8 lg:pt-10">
          ...
          >
            ...
            <div>
              ...
              <div className="flex flex-col gap-1.5">
                <Link
                  to="/about/"
                  className="font-[200] text-[16px] text-[#9CA3AF] hover:text-[#19B8F5] transition"
                >
                  About Us
                </Link>
        ...
        {/* Bottom Divider */}
        <div className="border-t border-[#616161] mt-10 pt-8">
