...
export default function SMMHiringHero() {
  ...
  return (
    <div className="h-content pb-15 font-sans" style={{ backgroundColor: "#f0f8fd" }}>
      ...
      {/* ── Navbar ── */}
      <nav className="flex items-center justify-between bg-white border-b border-gray-100 relative px-5 py-3 sm:px-10 sm:py-3 md:px-16 md:py-3.5 lg:px-24 lg:py-4 xl:px-32 xl:py-4">
        ...
        {/* Hire Now */}
        <button className="bg-[#12B3EF] hover:bg-[#0fa0d6] text-white text-[12px] sm:text-[13px] md:text-[14px] font-semibold px-4 py-1.5 sm:px-5 sm:py-2 md:px-6 md:py-2 rounded-full transition-colors">
          Hire Now
        </button>
      </nav>

      {/* ── Hero Section — no bottom padding ── */}
      <section className="flex flex-col md:flex-row items-center gap-8 md:gap-10 px-5 pt-10 pb-0 sm:px-10 sm:pt-12 sm:pb-0 md:px-16 md:pt-14 md:pb-0 lg:px-24 lg:pt-16 lg:pb-0 xl:px-32 xl:pt-16 xl:pb-0">
